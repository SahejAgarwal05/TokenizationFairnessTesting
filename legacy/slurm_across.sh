#!/bin/sh
#SBATCH --job-name=aya-8b  # create a short name for your job
...
cd /home/i/i0001574/workspace/alpha/TokenizationFairnessTesting
~/miniconda3/bin/wandb login 4bdc5d5b0ba67a677079a186c2fd8c304d9453ff # if you need wandb
sh /home/i/i0001574/workspace/alpha/TokenizationFairnessTesting/batch_all_across.sh  # this is the script you’ve tested in the adhoc session