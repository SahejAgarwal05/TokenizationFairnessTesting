...
os.environ["CUDA_VISIBLE_DEVICES"] = "3"#change when needed
import torch
...
def main():
    ...
    main_model_id = "meta-llama/Llama-3.2-3B-Instruct"
    ...
    for lang in all_langs:
        ...
        # ---------------------------------------------------------------------
        main_model_id = main_model_id.split("/")
        filename = f"{main_model_id}_simplePruning_{lang}_183.jsonl"
